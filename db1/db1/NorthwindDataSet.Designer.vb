...
Partial Public Class NorthwindDataSet
    ...
    Partial Public Class ProductsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddProductsRow(ByVal ProductName As String, ByVal CategoryID As Integer, ByVal UnitPrice As Decimal, ByVal UnitsInStock As Short) As ProductsRow
            Dim rowProductsRow As ProductsRow = CType(Me.NewRow,ProductsRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, ProductName, CategoryID, UnitPrice, UnitsInStock}
    ...
    Partial Public Class ProductsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Products] WHERE (([ProductID] = @Original_ProductID) AND ([Pro"& _ 
                ...
                " IS NULL) OR ([CategoryID] = @Original_CategoryID)) AND ((@IsNull_UnitPrice = 1 "& _ 
                "AND [UnitPrice] IS NULL) OR ([UnitPrice] = @Original_UnitPrice)) AND ((@IsNull_U"& _ 
                "nitsInStock = 1 AND [UnitsInStock] IS NULL) OR ([UnitsInStock] = @Original_Units"& _ 
                "InStock)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([ProductName], [CategoryID], [UnitPrice], [UnitsInS"& _ 
                "tock]) VALUES (@ProductName, @CategoryID, @UnitPrice, @UnitsInStock);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Pr"& _ 
                "oductID, ProductName, CategoryID, UnitPrice, UnitsInStock FROM Products WHERE (P"& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Products] SET [ProductName] = @ProductName, [CategoryID] = @Categor"& _ 
                "yID, [UnitPrice] = @UnitPrice, [UnitsInStock] = @UnitsInStock WHERE (([ProductID"& _ 
                "] = @Original_ProductID) AND ([ProductName] = @Original_ProductName) AND ((@IsNu"& _ 
                "ll_CategoryID = 1 AND [CategoryID] IS NULL) OR ([CategoryID] = @Original_Categor"& _ 
                "yID)) AND ((@IsNull_UnitPrice = 1 AND [UnitPrice] IS NULL) OR ([UnitPrice] = @Or"& _ 
                "iginal_UnitPrice)) AND ((@IsNull_UnitsInStock = 1 AND [UnitsInStock] IS NULL) OR"& _ 
                " ([UnitsInStock] = @Original_UnitsInStock)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ProductID, ProductName, Ca"& _ 
                "tegoryID, UnitPrice, UnitsInStock FROM Products WHERE (ProductID = @ProductID)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.db1.My.MySettings.Default.NorthwindConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ProductID, ProductName, CategoryID, UnitPrice, UnitsInStock FROM dbo.Produ"& _ 
                "cts"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ProductID As Integer, ByVal Original_ProductName As String, ByVal Original_CategoryID As Global.System.Nullable(Of Integer), ByVal Original_UnitPrice As Global.System.Nullable(Of Decimal), ByVal Original_UnitsInStock As Global.System.Nullable(Of Short)) As Integer
            ...
            If (Original_UnitsInStock.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(7).Value = CType(Original_UnitsInStock.Value,Short)
            Else
        ...
        Public Overloads Overridable Function Insert(ByVal ProductName As String, ByVal CategoryID As Global.System.Nullable(Of Integer), ByVal UnitPrice As Global.System.Nullable(Of Decimal), ByVal UnitsInStock As Global.System.Nullable(Of Short)) As Integer
            ...
            If (UnitsInStock.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(3).Value = CType(UnitsInStock.Value,Short)
            Else
        ...
        Public Overloads Overridable Function Update(ByVal ProductName As String, ByVal CategoryID As Global.System.Nullable(Of Integer), ByVal UnitPrice As Global.System.Nullable(Of Decimal), ByVal UnitsInStock As Global.System.Nullable(Of Short), ByVal Original_ProductID As Integer, ByVal Original_ProductName As String, ByVal Original_CategoryID As Global.System.Nullable(Of Integer), ByVal Original_UnitPrice As Global.System.Nullable(Of Decimal), ByVal Original_UnitsInStock As Global.System.Nullable(Of Short), ByVal ProductID As Integer) As Integer
            If (ProductName Is Nothing) Then
                Throw New Global.System.ArgumentNullException("ProductName")
            Else
            ...
            If (Original_UnitsInStock.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(11).Value = CType(Original_UnitsInStock.Value,Short)
            Else
                Me.Adapter.UpdateCommand.Parameters(10).Value = CType(1,Object)
                Me.Adapter.UpdateCommand.Parameters(11).Value = Global.System.DBNull.Value
            End If
            Me.Adapter.UpdateCommand.Parameters(12).Value = CType(ProductID,Integer)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal ProductName As String, ByVal CategoryID As Global.System.Nullable(Of Integer), ByVal UnitPrice As Global.System.Nullable(Of Decimal), ByVal UnitsInStock As Global.System.Nullable(Of Short), ByVal Original_ProductID As Integer, ByVal Original_ProductName As String, ByVal Original_CategoryID As Global.System.Nullable(Of Integer), ByVal Original_UnitPrice As Global.System.Nullable(Of Decimal), ByVal Original_UnitsInStock As Global.System.Nullable(Of Short)) As Integer
            Return Me.Update(ProductName, CategoryID, UnitPrice, UnitsInStock, Original_ProductID, Original_ProductName, Original_CategoryID, Original_UnitPrice, Original_UnitsInStock, Original_ProductID)
        End Function
    End Class
